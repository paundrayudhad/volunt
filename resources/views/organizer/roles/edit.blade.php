    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('organizer.events.roles.update', [$org->slug, $event->slug, $peran->id]) }}" class="p-6 space-y-4">
                    @csrf
                    @method('PATCH')
                    ...
                    <div>
                        ...
                        <select id="division_id" name="division_id"
                            ...
                            @foreach ($divisi as $satu)
                                <option value="{{ $satu->id }}" @selected(old('division_id', $peran->division_id) == $satu->id)>{{ $satu->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                            :value="old('name', $peran->name)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="location" name="location" type="text" class="mt-1 block w-full"
                            :value="old('location', $peran->location)" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700">{{ old('description', $peran->description) }}</textarea>
