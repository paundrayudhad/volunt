    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('organizer.events.divisions.update', [$org->slug, $event->slug, $divisi->id]) }}" class="p-6 space-y-4">
                    @csrf
                    @method('PATCH')
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700">{{ old('description', $divisi->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="supervisor_id" name="supervisor_id" type="number" class="mt-1 block w-full"
                            :value="old('supervisor_id', $divisi->supervisor_id)" />
